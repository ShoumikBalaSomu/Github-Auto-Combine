...
def generate_epg(channels: list):
    ...
    try:
        with open(OUTPUT_EPG, 'w', encoding='utf-8') as f:
            ...
            f.write('<tv generator-info-name="IPTV Auto-Combine V8 Titan" generator-info-url="https://github.com/shoumikbalasomu/Github-Auto-Combine">\n')
            ...
            for ch in channels:
                ...
                f.write(f'    <desc lang="en">Live 24/7 broadcast from {ch.name}. Managed by IPTV Auto-Combine V8 Titan.</desc>\n')
                if ch.group:
